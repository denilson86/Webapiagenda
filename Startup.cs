...
namespace WebApi.Agenda
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddEntityFrameworkStore(Configuration.GetConnectionString("ApiDbContext"));
            ...
            //services.AddDbContext<ApiDbContext>(options => options.UseSqlServer("ApiDbContext"));
        }
